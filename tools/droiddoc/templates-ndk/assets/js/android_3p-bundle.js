...
PR['registerLangHandler'](
    PR['createSimpleLexer'](
        ...
        [
         ...
         [PR['PR_TYPE'], /^(?:-?GERPGR|=MINUS|2BCADR|VN|BOF|MM|-?2CADR|-?[1-6]DRPGR|ADRES|BBCON|[SE]?BANK\=?|BLOCK|BNKSUM|E?CADR|COUNT\*?|2?DEC\*?|-?DNCHAN|-?DNPTR|EQUALS|ERASE|MEMORY|2?OCT|REMADR|SETLOC|SUBRO|ORG|BSS|BES|SYN|EQU|DEFINE|END)\s/,null],
